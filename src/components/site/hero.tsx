    ...
    <section className="relative flex min-h-[min(900px,100svh)] flex-col items-center justify-center overflow-hidden px-4 pb-20 pt-32 sm:px-6 md:pb-24">
      ...
      >
        ...
        <div className="flex flex-col items-start md:items-center w-full mb-8 md:mb-12">
          <h1 className="w-full max-w-full whitespace-nowrap text-center font-[var(--font-anton)] text-[clamp(2rem,6vw,11rem)] leading-[0.85] uppercase tracking-[-0.04em] text-white animate-hero-rise drop-shadow-[0_0_30px_rgba(255,255,255,0.2)]">
            {title}
          </h1>
        </div>
