      ...
      <div className="flex-1 w-full max-w-[1100px] mx-auto px-4 sm:px-6 py-6 md:py-10 space-y-12 relative z-10 mt-16 md:mt-24">
        ...
        <section className="grid md:grid-cols-2 gap-6 sm:gap-8 pt-2">
              ...
              <div className="bg-[#120E1C]/60 border border-white/[0.05] shadow-[0_8px_30px_rgba(0,0,0,0.3)] rounded-[2rem] p-8 flex flex-col justify-between min-h-[260px] text-center backdrop-blur-sm opacity-90 hover:opacity-100 transition-opacity">
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center">
                    <div className="space-y-6 w-full flex flex-col items-center">
                        <p className="text-white/40 font-medium text-sm">You have not applied for the Club Partner program yet.</p>
                        <button onClick={() => toast.info("Club Partner applications are coming soon!")} disabled={!!ambassador} className="bg-white/5 hover:bg-white/10 hover:text-white disabled:hover:bg-white/5 disabled:hover:text-white/50 text-white/50 transition-all duration-300 border border-white/10 px-8 py-3 rounded-full text-xs font-bold tracking-[0.2em] uppercase shadow-lg disabled:opacity-30 disabled:cursor-not-allowed w-full max-w-[220px]">
                            Apply for Partner
                        </button>
                    </div>
                  </div>
