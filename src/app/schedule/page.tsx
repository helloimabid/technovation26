      ...
      <div className="pt-24 bg-[#06061b] min-h-screen text-white pb-32">
        <div className="py-12 md:py-24 px-6 md:px-12 max-w-5xl mx-auto relative z-10 w-full">
          <div className="text-center mb-20">
            <h1 className="whitespace-nowrap text-[clamp(2.5rem,8vw,4.5rem)] font-bold mb-6 uppercase font-[var(--font-anton)] tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-white to-white/50">
